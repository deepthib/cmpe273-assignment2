...
public interface BookRepositoryInterface {
	...
	void config(LibraryServiceConfiguration configuration);

	void producer(Long isbn) throws JMSException;
	
	void statusUpdate(Book book);

	//void listener(LibraryServiceConfiguration configuration) throws JMSException;
}
